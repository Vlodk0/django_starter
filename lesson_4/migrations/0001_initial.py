...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fresh_period', models.DurationField(default=datetime.timedelta(days=5), help_text='Use this field '
                                                                                                    'when you need to'
                                                                                                    ' have '
                                                                                                    'information '
                                                                                                    'about bouquet '
                ...
                ('flowers', models.ManyToManyField(to='lesson_4.flower', verbose_name='This bouquet consists of these '
                                                                                      'flowers')),
            ],
        ),
    ]
